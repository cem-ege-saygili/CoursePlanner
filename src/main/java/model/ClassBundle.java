...
public class ClassBundle implements Serializable {
    ...
    private List<model.Class> classList;
    ...
    public void add(model.Class c){
        for(model.Class curClass:classList){
    ...
    public void addAll(List<model.Class> classes){
        for(Class c:classes)
            add(c);
    }
    ...
    public static List<ClassBundle> GenerateClassBundlesFromClasses(List<model.Class> classes){

        List<ClassBundle> bundles = new ArrayList<>();
        List<model.Class> prb_classes = new ArrayList<>();
        List<model.Class> lec_classes = new ArrayList<>();
        List<model.Class> dis_classes = new ArrayList<>();
        List<model.Class> lab_classes = new ArrayList<>();

        boolean lecFlag = false;
        boolean prbFlag = false;
        boolean labFlag = false;

        for(model.Class curClass:classes){
        ...
        List<List<model.Class>> lecPrbLabDisLists = new ArrayList<>();
        ...
        List<List<model.Class>> cartesianProductsList = CartesianProduct.GenerateCartesianProducts(lecPrbLabDisLists);

        for(List<model.Class> curCartesianProductList:cartesianProductsList) {

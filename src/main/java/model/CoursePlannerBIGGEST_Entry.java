...
public class CoursePlannerBIGGEST_Entry {
    ...
    public CoursePlannerBIGGEST_Entry(String Component, String Subject, int Catalog, String Section, int CourseID, String Descr, int TopicID,

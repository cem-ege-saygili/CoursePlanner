...
import model.DB_Utilities.SelectFromTableInDB;
import model.ActiveClassFilterElement;
import model.Class;
import model.CourseSubject_Catalog_Tuple;
import model.DayTimeFramePair;
...
public class Serializer {
    ...
    public static void SerializeOut(List<Schedule> schedules,
        ...
        for(CourseSubject_Catalog_Tuple curTuple:tupleList){//write courses
...
//        }else if(obj instanceof CourseSubject_Catalog_Tuple){
//            CourseSubject_Catalog_Tuple scpTuple = (CourseSubject_Catalog_Tuple) obj;
...
//        }
    ...
    public static void SerializeIn(File chosenFile,
                                   ...
                                   List<List<model.Class>> classesList,
                                   List<CourseSubject_Catalog_Tuple> tupleList,
...
//                System.out.println(curSchedule.getClassBundleList());
                ShowSerializeInProgress2User(lblStatusBar,
                                            ...
                                            completeLength,
                                            curSchedule);
            }else if(obj instanceof CourseSubject_Catalog_Tuple){//read courses
                ...
                CourseSubject_Catalog_Tuple curTuple = (CourseSubject_Catalog_Tuple) obj;

...
//        priorityValuesComboBox.setBounds(COURSE_SELECTION_COMBO_X_MARGIN, (COURSE_SELECTION_Y_MARGIN + 2 * COURSE_SELECTION_HEIGHT), COURSE_SELECTION_WIDTH, COURSE_SELECTION_HEIGHT);
        ...
        btnAdd2PlanningList.setBounds(COURSE_MANAGEMENT_X_MARGIN, COURSE_MANAGEMENT_Y_MARGIN, COURSE_MANAGEMENT_WIDTH, COURSE_MANAGEMENT_HEIGHT);
        btnRemoveFromPlanningList.setBounds(COURSE_MANAGEMENT_X_MARGIN, (COURSE_MANAGEMENT_Y_MARGIN + COURSE_MANAGEMENT_HEIGHT), COURSE_MANAGEMENT_WIDTH, COURSE_MANAGEMENT_HEIGHT);
...
//                scheduleFrame = wst.getScheduleFrame();
    ...
    private static void ShowMessageNow(String message, String title, boolean isScrollable) {
        ShowMessageNow(message, title, JOptionPane.PLAIN_MESSAGE, isScrollable);
    }

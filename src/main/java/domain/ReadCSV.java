...
//    public ReadCSV(String fPath, List<ClassInfo> records){
//        this.records = records;
//        this.fPath = fPath;
//    }

    public static void FillIntoList(String fPath, List<ClassInfo> records){//default delimiter is set to be semi_colon
        FillIntoList(fPath, SEMICOLON_DELIMITER, records);
    }

    public static void FillIntoList(String fPath, String CSV_Delimiter, List<ClassInfo> records){
